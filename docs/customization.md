...
- `environment.d/qt.conf` — Sets `QT_STYLE_OVERRIDE=breeze-dark` and `QT_QPA_PLATFORMTHEME=qt6ct`
...
# Edit ~/.config/environment.d/qt.conf
# Change QT_STYLE_OVERRIDE=breeze-dark to QT_STYLE_OVERRIDE=breeze
```
